...
if(!$_SESSION){
    ...
    if($kode_petugas==''){
        ...
        WHERE tgl_donasi BETWEEN '$dari_bank_tgl' AND '$sampai_bank_tgl' AND metode='MUTASI BANK' AND status='Aktif'
        ...
        WHERE tgl_donasi BETWEEN '$dari_bank_tgl' AND '$sampai_bank_tgl' AND metode='MUTASI BANK' AND createdby='$kode_petugas' AND status='Aktif'
