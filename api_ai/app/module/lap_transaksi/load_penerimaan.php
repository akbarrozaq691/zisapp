...
if(!$_SESSION){
    ...
    if($kode_petugas==''){
        ...
        WHERE tgl_donasi BETWEEN '$dari_tgl' AND '$sampai_tgl' AND metode='CASH'  AND status ='Aktif'
        ...
        WHERE tgl_donasi BETWEEN '$dari_tgl' AND '$sampai_tgl' AND metode='CASH' AND createdby='$kode_petugas' AND status ='Aktif'
